...
//        assertSimpleName("Testdroid Plugin for CI", "Testdroid");
    ...
    public void testDuplicateDetection() throws Exception {
        ...
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0", "hpi"), plugin, 0);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0", "hpi"), plugin, 0);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0.0", "hpi"), plugin, 0);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-other-group", "foo", "1.0", "hpi"), plugin, 0);
    ...
    public void testKeepOlder() throws Exception {
        ...
        Logger.getLogger(Plugin.class.getName()).addHandler(handler);
        TestRepository repository = new TestRepository();
        final HPI first = registerAndAdd(repository, ArtifactCoordinates.create("the-group", "foo", "1.0", "hpi"), plugin, 1);
        plugin.addArtifact(first);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0", "hpi"), plugin, 2);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0.0", "hpi"), plugin, 1);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-other-group", "foo", "1.0", "hpi"), plugin, 4);
    ...
    public void testReplaceAll() throws Exception {
        ...
        Logger.getLogger(Plugin.class.getName()).addHandler(handler);
        TestRepository repository = new TestRepository();
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0", "hpi"), plugin, 4);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0", "hpi"), plugin, 3);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0.0", "hpi"), plugin, 2);
        final HPI oldest = registerAndAdd(repository,  ArtifactCoordinates.create("the-other-group", "foo", "1.0", "hpi"), plugin, 1);
    ...
    public void testRemoveAll() throws Exception {
        ...
        TestRepository repository = new TestRepository();
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0", "hpi"), plugin, 0);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0", "hpi"), plugin, 42);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-group", "foo", "1.0.0.0", "hpi"), plugin, 42);
        registerAndAdd(repository,  ArtifactCoordinates.create("the-other-group", "foo", "1.0", "hpi"), plugin, 0);
