...
public class MaintainersSourceTest {
    ...
    public void testContent() {
        final List<MaintainersSource.Maintainer> maintainers = MaintainersSource.getInstance().getMaintainers(
                ArtifactCoordinates.create("org.jenkins-ci.plugins", "matrix-auth", "unused", "unused"));
