...
```
  ...
  java  -DGITHUB_USERNAME=baisui1981 -DGITHUB_PASSWORD=**** -Dtis.plugin.release.version=3.0.0 io.jenkins.update_center.Main --id default --resources-dir /opt/misc/update-center2/resources
```
