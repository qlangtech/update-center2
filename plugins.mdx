...
3. 文件格式
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@26a33cf
...
2. index
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@118a4d5
...
* **插件包:** [tis-datax-hdfs-aliyun-emr-plugin/tis-datax-hdfs-aliyun-emr-plugin_hadoop_2.7.3.tpi](./tpis#tis-datax-hdfs-aliyun-emr-plugin/tis-datax-hdfs-aliyun-emr-plugin_hadoop_273tpi)
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4ac7856f
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@498b611e
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.3.0/tis/flink-tis-1.18.1-bin.tar.gz && rm -rf flink-tis-1.18.1 && mkdir flink-tis-1.18.1 && tar xvf flink-tis-1.18.1-bin.tar.gz -C ./flink-tis-1.18.1
		   ```
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@10dbf660
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@311a09b2
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@57920d6c
	* **说明:** 		无
...
1. 工作流名称
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6edb1e9c
...
1. upsertKey
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@2ca132ad
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4d0b7fd5
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6338afe2
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@3d02ff64
	* **说明:** 		选择列作为表的主键
...
2. 主键
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@718ad3a6
	* **说明:** 		选择列作为表的主键
