...
* **插件包:** [tis-hive-plugin/tis-hive-plugin_hive_2.1.1-cdh6.3.2_hadoop_3.0.0-cdh6.3.2.tpi](./tpis#tis-hive-plugin/tis-hive-plugin_hive_211-cdh632_hadoop_300-cdh632tpi)
...
1. 配置模版
	...
	* **默认值:** com.qlangtech.tis.plugin.datax.DataXCassandraWriter.getDftTemplate()
...
3. index
	...
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@d949bc4
...
1. 配置模版
	...
	* **说明:** 无特殊情况请不要修改模版内容，避免不必要的错误
	* **默认值:** com.qlangtech.tis.plugin.datax.DataXCassandraReader.getDftTemplate()
...
3. serverPort
	...
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@67c0c90b
...
1. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@50f3ba6a
...
2. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@79c4f23b
...
### com.qlangtech.tis.plugin.datax.common.impl.NoneCreateTable

* **显示名:** off 

* **全路径名:** [com.qlangtech.tis.plugin.datax.common.impl.NoneCreateTable](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-common-plugin/src/main/java/com/qlangtech/tis/plugin/datax/common/impl/NoneCreateTable.java) 
...
5. memoryRequest
	...
	* **默认值:** com.qlangtech.tis.datax.DataXJobSubmitParams.dftMemory()
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.1.0-SNAPSHOT/tis/flink-tis-1.18.1-bin.tar.gz && rm -rf flink-tis-1.18.1 && mkdir flink-tis-1.18.1 && tar xvf flink-tis-1.18.1-bin.tar.gz -C ./flink-tis-1.18.1
		   ```
...
4. Event deserialization failure handling
...
7. Specifies whether the connector supports mining LOB fields and operations
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@30a01dd8
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@1bc6c20d
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@71468613
...
2. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@1b19712f
...
1. upsertKey
	...
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4e9e0c6
...
## com.qlangtech.tis.plugin.datax.common.AutoCreateTable<com.qlangtech.tis.plugin.datax.doris.DorisAutoCreateTable.DorisColWrapper>
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@7ee2423
...
1. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@2a54c92e
...
1. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@58ec8271
...
### com.qlangtech.tis.plugin.datax.common.impl.AutoCreateTableColCommentSwitchOFF

* **显示名:** off 

* **全路径名:** [com.qlangtech.tis.plugin.datax.common.impl.AutoCreateTableColCommentSwitchOFF](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-common-plugin/src/main/java/com/qlangtech/tis/plugin/datax/common/impl/AutoCreateTableColCommentSwitchOFF.java) 
