...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@3e9b3b3c
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@294ebe11
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6b64429e
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@3df04fa1
	* **说明:** 		无
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@77998ea7
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@5dd3727c
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@391dfe7c
	* **说明:** 		选择列作为表的主键
