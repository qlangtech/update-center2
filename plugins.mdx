...
3. 文件格式
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@f49e81a
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@1fc5c0b2
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@5a2f401a
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@54556723
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.1.0/tis/flink-tis-1.18.1-bin.tar.gz && rm -rf flink-tis-1.18.1 && mkdir flink-tis-1.18.1 && tar xvf flink-tis-1.18.1-bin.tar.gz -C ./flink-tis-1.18.1
		   ```
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6c75e3bc
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@23ec63af
	* **说明:** 		无
...
1. upsertKey
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@2ef913a4
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@1d9bd1d6
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@3b66ac74
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4bc21e34
	* **说明:** 		选择列作为表的主键
...
2. 别名前缀
	...
	* **必须:** 否
	* **默认值:** 无
	* **说明:** 		统一为目标表添加前缀，例如在构建分层数仓用于为ods层目标表统一添加“ods_erp_”前缀
