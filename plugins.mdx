...
* **全路径名:** [com.qlangtech.tis.plugin.datax.meta.NoneMetaDataWriter](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-ftp-plugin/src/main/java/com/qlangtech/tis/plugin/datax/meta/NoneMetaDataWriter.java) 
...
* **全路径名:** [com.qlangtech.tis.plugin.datax.meta.DefaultMetaDataWriter](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-ftp-plugin/src/main/java/com/qlangtech/tis/plugin/datax/meta/DefaultMetaDataWriter.java) 
...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@38eb2fb0
...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@5e268ce6
...
### com.qlangtech.tis.plugin.ds.starrocks.BasicSourceFactory

* **显示名:** Doris 

* **全路径名:** [com.qlangtech.tis.plugin.ds.starrocks.BasicSourceFactory](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-starrocks-plugin/src/main/java/com/qlangtech/tis/plugin/ds/starrocks/BasicSourceFactory.java) 
	...
	* **说明:** 
		...
		2. Standalone: [详细请查看](https://nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/resource-providers/standalone/overview/)
		   ...
		   [安装说明](http://tis.pub/docs/install/flink-cluster/standalone/):
		      - 下载、解压
		        ```shell script
		         wget http://tis-release.oss-cn-beijing.aliyuncs.com/3.7.2/tis/flink-tis-1.13.1-bin.tar.gz && rm -rf flink-tis-1.13.1 && mkdir flink-tis-1.13.1 && tar xvf flink-tis-1.13.1-bin.tar.gz -C ./flink-tis-1.13.1
		        ```
		      - 启动Flink-Cluster：
		         ```shell script
...
4. index
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@16073fa8
...
4. column
	...
	* **说明:** 
		 ...
		 * 类型转换
		 ...
		 | Boolean  | boolean |
		 | Bytes    | bytes |
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@787f32b7
...
5. collectionName
	...
	* **说明:** MonogoDB的集合名。【必填】
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@6aef4eb8
...
2. uniqueKey
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@53c68ce
...
3. uniqueKey
	...
	* **说明:** 
		...
		* 注意：如果此参数为空，并且写入模式为 update 和 replace 时，应用会自动获取数据库中的唯一索引；
		如果数据表没有唯一索引，但是写入模式配置为 update 和 replace，应用会以 insert 的方式写入数据；
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@75e710b
...
### com.qlangtech.plugins.incr.flink.chunjun.doris.sink.DorisTabProps

* **显示名:** DorisTabProps 

* **全路径名:** [com.qlangtech.plugins.incr.flink.chunjun.doris.sink.DorisTabProps](https://github.com/qlangtech/plugins/tree/master/tis-incr/tis-flink-chunjun-doris-plugin/src/main/java/com/qlangtech/plugins/incr/flink/chunjun/doris/sink/DorisTabProps.java) 
...
2. uniqueKey
	...
	* **说明:** 
		...
		* 注意：如果此参数为空，并且写入模式为 update 和 replace 时，应用会自动获取数据库中的唯一索引；
		如果数据表没有唯一索引，但是写入模式配置为 update 和 replace，应用会以 insert 的方式写入数据；
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@8ff5094
...
* **全路径名:** [com.qlangtech.tis.config.hive.impl.OffHiveUserToken](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-hive-plugin/src/main/java/com/qlangtech/tis/config/hive/impl/OffHiveUserToken.java) 
...
### com.qlangtech.tis.plugin.datax.DataXFtpReaderWithMeta

* **显示名:** FTP-Meta 

* **全路径名:** [com.qlangtech.tis.plugin.datax.DataXFtpReaderWithMeta](https://github.com/qlangtech/plugins/tree/master/tis-datax/tis-datax-ftp-plugin/src/main/java/com/qlangtech/tis/plugin/datax/DataXFtpReaderWithMeta.java) 
