...
<tr>
<td class='endtype-name'>Oracle</td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxoraclereader'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxoraclewriter'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link flink-cdc-color'><Link to={plugins.metadata.permalink+'#comqlangtechpluginsincrflinkcdcoracleflinkcdcoraclesourcefactory'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link chunjun-color'><Link to={plugins.metadata.permalink+'#comqlangtechpluginsincrflinkchunjunoraclesinkchunjunoraclesinkfactory'}>1</Link></i></td></tr>
<tr>
<td class='endtype-name'>MariaDB</td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxmariareader'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxmariawriter'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link flink-cdc-color'><Link to={plugins.metadata.permalink+'#comqlangtechtispluginsincrflinkcdcmariaflinkcdcmariadbsourcefactory'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link chunjun-color'><Link to={plugins.metadata.permalink+'#comqlangtechtispluginsincrflinkmariasinkmariadbsinkfactory'}>1</Link></i></td></tr>
<tr>
...
<tr>
<td class='endtype-name'>Spark</td><td></td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxsparkwriter'}>1</Link></i></td><td></td><td></td></tr>
<tr>
